import { a as U0 } from "./chunk-RJEPFQGU.js";
import {
  a as xe,
  b as it,
  c as Uc,
...
var V0 = typeof ArrayBuffer == "function",
  Or = (e, t) => {
    if (typeof e != "string") return { type: "message", data: sl(e, t) };
    let n = e.charAt(0);
    return n === "b"
      ? { type: "message", data: W0(e.substring(1), t) }
      : Ar[n]
      ? e.length > 1
...
var Y0 = Ge.setTimeout,
  Z0 = Ge.clearTimeout;
function Ht(e, t) {
  t.useNativeTimers
    ? ((e.setTimeoutFn = Y0.bind(Ge)), (e.clearTimeoutFn = Z0.bind(Ge)))
...
function fl(e) {
  return typeof e == "string"
    ? X0(e)
    : Math.ceil((e.byteLength || e.size) * J0);
}
function X0(e) {
  let t = 0,
    n = 0;
    ...
    class e extends Ae {
      ...
      _cleanup(n) {
        if (!(typeof this._xhr > "u" || this._xhr === null)) {
          if (((this._xhr.onreadystatechange = Q0), n))
            try {
              this._xhr.abort();
            } catch {}
  ...
  return (
    n != -1 &&
      ...
      (o.authority = o.authority
        ...
        .replace(/;/g, ":")),
      (o.ipv6uri = !0)),
    (o.pathNames = rp(o, o.path)),
    (o.queryKey = ip(o, o.query)),
    o
  );
}
function rp(e, t) {
...
var sp = typeof ArrayBuffer == "function",
  ap = (e) =>
    typeof ArrayBuffer.isView == "function"
      ? ArrayBuffer.isView(e)
...
function Ir(e) {
  return (
    (sp && (e instanceof ArrayBuffer || ap(e))) ||
    (cp && e instanceof Blob) ||
    (lp && e instanceof File)
  );
}
function Pr(e, t) {
      ...
      switch (t) {
        ...
        case ve.BINARY_EVENT:
          return (
            Array.isArray(n) &&
            (typeof n[0] == "number" ||
              (typeof n[0] == "string" && up.indexOf(n[0]) === -1))
          );
        case ve.ACK:
        case ve.BINARY_ACK:
...
var Xe =
  ...
  Ot = [],
  vt = [],
  fp = typeof Uint8Array < "u" ? Uint8Array : Array,
  rc = !1;
function zd() {
  rc = !0;
  for (
...
Object.defineProperty(ze, "__esModule", { value: !0 }),
  ...
  (ze.exists = ih),
  (ze.output = oh);
var Op = { number: wo, bool: th, bytes: oc, hash: rh, exists: ih, output: oh };
(ze.default = Op),
  (function (e) {
...
Object.defineProperty(lt, "__esModule", { value: !0 }),
  ...
  (lt.exists = dh),
  (lt.output = hh);
var Lp = { number: _o, bool: ch, bytes: ac, hash: uh, exists: dh, output: hh };
lt.default = Lp;
var nn = {},
  Di = {};
    ...
    process(t, n) {
      ...
      for (let E = 0; E < 80; E++) {
        let N =
          ...
          F = (d & f) ^ (~d & m),
          q = (h & g) ^ (~h & v),
          z = fe.default.add5L(S, I, q, Bp[E], cn[E]),
          G = fe.default.add5H(z, p, N, F, Np[E], an[E]),
          U = 0 | z,
          P =
...
var $p = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function Ts(e) {
  Ao(e);
  let t = "";
...
(pe.notImplemented = () => {
  ...
  (ke.validateField = function (e) {
    let t = Up.reduce((n, r) => ((n[r] = "function"), n), {
      ORDER: "bigint",
      MASK: "bigint",
      BYTES: "isSafeInteger",
      BITS: "isSafeInteger",
  ...
  (sr.wNAF = function (e, t) {
    ...
    return {
      ...
      unsafeLadder(o, s) {
        let a = e.ZERO,
          c = o;
        for (; s > Hp; ) s & Is && (a = a.add(c)), (c = c.double()), (s >>= Is);
        return a;
      },
  ...
  function P(x) {
    let {
        ...
        let ls = E.eql(de, be),
          ...
          j0 = E.isOdd(kr);
        return (
          (kr = E.cmov(kr, E.neg(kr), ls !== j0)),
          { xMn: $0, xMd: ye, yMn: kr, yMd: d }
        );
      })(x),
      H = E.mul(k, K);
    H = E.mul(H, U);
...
(function (e) {
  ...
  (no.createCurve = function (e, t) {
    let n = (r) => (0, Zp.weierstrass)(xe(xe({}, e), Ql(r)));
...
function Ql(e) {
  return {
    hash: e,
    hmac: (t, ...n) => (0, Yp.hmac)(e, t, (0, Xl.concatBytes)(...n)),
  ...
  let D = (0, i.isogenyMap)(
      ...
      [
        ...
        [
          ...
          "0xe33f33435339e87d0a27a4609a0ffab1f593776f00000000000000000000000001",
        ],
        [
    ...
    return (
      ...
      (a, c, l, u, d = 0) => {
        ...
        if (v === 32) f.push((g = (0, yt.copyBytes)(a))), (m = ef);
          ...
          (g = new Uint8Array(32)), g.set(a), g.set(a, 16), (m = r1), f.push(g);
        }
...
var qt = ze,
  ...
  t1 = Qh("expand 16-byte k"),
  n1 = Qh("expand 32-byte k"),
  r1 = (0, yt.u32)(t1),
  ef = (0, yt.u32)(n1);
function Hs(e) {
...
(Oo.xchacha20 = function (e, t, n) {
  return (0, o1.xchacha20poly1305)(e, t, n);
}),
  (function (e) {
    Object.defineProperty(e, "__esModule", { value: !0 }),
...
var pu = ht,
  ...
  c1 = (function () {
    function e(t) {
      ...
      this.publicKey = new a1.PublicKey((0, nr.getPublicKey)(this.data));
    }
    return (
      (e.fromHex = function (t) {
...
function gu(e, t) {
  ...
  n &&
    ...
    h1.forEach(({ event: i, handler: o }) => {
      n?.on(`${i}-${t}`, o(e, t));
    }),
    f1.forEach(({ event: i, handler: o }) => {
      r?.on(i, o(e));
    }),
...
var Aa = class extends _r.EventEmitter2 {
    ...
    initSocket() {
      ...
      let { otherPublicKey: n, ecies: r, logging: i } = this.options,
        o = { autoConnect: !1, transports: l1, withCredentials: !0 },
...
function vu({
  ...
  let q = {
    [te.AUTHORIZED]: p1(o),
    [te.MESSAGE]: w1(o),
    [te.CHANNEL_PERSISTENCE]: C1(o),
    [te.CLIENTS_CONNECTED]: g1(o, e),
    [te.KEYS_EXCHANGED]: b1(o, e),
    [te.SOCKET_DISCONNECTED]: _1(o),
    [te.SOCKET_RECONNECT]: E1(o),
    [te.CLIENTS_DISCONNECTED]: y1(o),
    [te.KEY_INFO]: () => {},
    [te.CHANNEL_CREATED]: m1(o),
    [te.CLIENTS_WAITING]: v1(o),
    [te.RPC_UPDATE]: (z) => {
...
var Yi,
  ...
  ui =
    ...
    (xu = Mn("any", () => !0)),
    (Au = (e) => (
      (function (t, n, r = "Assertion failed", i = O1) {
        try {
          hf(t, n);
        } catch (o) {
          throw R1(i, `${r}: ${T1(o)}.`);
...
var Gr = mf("2.0"),
  ...
  H1 = li({ id: oo, jsonrpc: Gr, method: Tn(), params: Io(Sf) }),
  F1 = li({ jsonrpc: Gr, method: Tn(), params: Io(Sf) });
function Mu(e) {
  return Cr(e, H1);
}
function Tu(e) {
...
var Ru = vn.internal,
  z1 = "Unspecified error message. This is a bug, please report it.",
  q1 = { code: Ru, message: kf(Ru) },
  V1 = "Unspecified server error.";
function kf(e, t = z1) {
  if (
    (function (n) {
...
function Ou(e, { fallbackError: t = q1, shouldIncludeStack: n = !0 } = {}) {
  if (!Tu(t))
    throw new Error(
...
var G1 = Qo(Af),
  Wt = class extends Error {
    ...
    toString() {
      return G1(this.serialize(), Y1, 2);
    }
  };
function Y1(e, t) {
  if (t !== "[Circular]") return t;
}
var Yr = (e) => Z1(vn.invalidRequest, e);
function Z1(e, t) {
  let [n, r] = (function (i) {
    if (i) {
...
var X1 = class extends J1.EventEmitter {
    emit(e, ...t) {
      let n = e === "error",
        r = this._events;
  ...
  return we(this, null, function* () {
    try {
      let n = yield (function () {
        return we(this, null, function* () {
          return { name: nm(window), icon: yield rm(window) };
        });
      })();
      e.handle(
        {
...
function rm(e) {
  return we(this, null, function* () {
    ...
    for (let r of Array.from(n)) if (r && (yield im(r.href))) return r.href;
    return null;
  });
}
function im(e) {
...
function ns(e) {
  ...
  for (
    var r = arguments,
      i = r.length,
      o = String(e).replace(cm, function (a) {
        if (a === "%%") return "%";
        if (n >= i) return a;
        switch (a) {
          case "%s":
...
function Wf() {
  console.log(
    ...
    (function () {
      ...
      return [e.getDate(), dm[e.getMonth()], t].join(" ");
    })(),
...
var ea,
  ...
  bi = yi(Object.freeze({ __proto__: null, default: mm }));
function gm() {
  if (Zu) return ea;
  function e(t) {
    try {
...
function fo(e) {
  switch (
    ...
    (function (t) {
      if (t && !ym(t)) throw new Error("Unknown encoding: " + t);
    })(e),
    this.encoding)
  ) {
    case "utf8":
    ...
    case "ucs2":
    case "utf16le":
      (this.surrogateSize = 2), (this.detectIncompleteChar = bm);
      break;
    case "base64":
      (this.surrogateSize = 3), (this.detectIncompleteChar = wm);
      break;
    default:
      return void (this.write = vm);
  }
...
var n0 = Yt,
  is = qn.codes,
  Cm = is.ERR_METHOD_NOT_IMPLEMENTED,
  Sm = is.ERR_MULTIPLE_CALLBACK,
  km = is.ERR_TRANSFORM_ALREADY_TRANSFORMING,
  xm = is.ERR_TRANSFORM_WITH_LENGTH_0,
  po = wr();
function Am(e, t) {
  var n = this._transformState;
  n.transforming = !1;
  var r = n.writecb;
  if (r === null) return this.emit("error", new Sm());
...
function od(e, t, n) {
  ...
  if ((n != null && e.push(n), e._writableState.length)) throw new xm();
  if (e._transformState.transforming) throw new km();
  return e.push(null);
}
bi(Yt, po),
...
var i0 = qn.codes,
  Rm = i0.ERR_MISSING_ARGS,
  Om = i0.ERR_STREAM_DESTROYED;
function sd(e) {
  if (e) throw e;
}
function ad(e) {
...
var sa = Er,
  ...
  Um = class extends sa.Duplex {
    ...
    createStream(e) {
      ...
      let t = new Km.Substream({ parent: this, name: e });
      return (
        (this._substreams[e] = t),
        (function (n, r) {
          let i = (0, jm.default)(r);
...
Uo.ObjectMultiplex = Um;
var Hm = Qo(Uo.ObjectMultiplex),
...
var Vm = Af,
  Fo = class extends Error {
    ...
    toString() {
      return Vm.default(this.serialize(), Wm, 2);
    }
  };
...
var dd = "direct",
  ...
  Ym = Object.keys(Vo).map((e) => e.toLowerCase()),
  d0 = [
    "eth_signTypedData",
    "eth_signTypedData_v3",
    "eth_signTypedData_v4",
...
var Jm = typeof window < "u" && window.localStorage;
function Xm({ instance: e, msg: t }) {
  return J(this, void 0, void 0, function* () {
    if (
      (e._initialized ||
        (Y(
...
var n2 = "sdk",
  Va = class {
    ...
    send({ event: t, params: n }) {
      ...
      let r = Object.assign(
        Object.assign(
          { id: n2, event: t, sdkVersion: Vn.version },
          this.originatorInfo
        ),
        { params: n }
      );
...
var Wa = ({ provider: e, sdkInstance: t }) => {
  ...
  Yo;
function o2({ mustBeMetaMask: e, sdkInstance: t }) {
  return J(this, void 0, void 0, function* () {
  ...
  u2 = (function () {
    ...
    return (
      ...
      (e.prototype._onMessageFromForwarder = function (t) {
        return c2(this, 0, void 0, function () {
          return l2(this, function (n) {
            switch (n.label) {
              case 0:
                switch (this.state) {
                  case wd:
...
function m2(e, t, { initialCheck: n, connectWith: r } = {}) {
...
var Za = class {
  constructor(t) {
    ...
    (this.state.developerMode = o),
      ...
      t.modals.install || (t.modals.install = h2),
      t.modals.otp || (t.modals.otp = f2);
  }
  startConnection(t) {
    return J(this, void 0, void 0, function* () {
      return m2(this.state, this.options, t);
    });
  }
          ...
          if (E.dappMetadata) {
            E.dappMetadata.iconUrl &&
              ...
              E.dappMetadata.base64Icon &&
                E.dappMetadata.base64Icon.length > i2 &&
                (console.warn(
    ...
    let {
      ...
      return J(this, void 0, void 0, function* () {
        ...
        if (
          ...
          try {
            (z = yield o2({ mustBeMetaMask: !0, sdkInstance: S })),
              (window.extension = z),
      ...
      return J(this, void 0, void 0, function* () {
        return (function (t) {
          ...
          return J(this, void 0, void 0, function* () {
            ...
            try {
              (t.sdkInitPromise = g2(t)), yield t.sdkInitPromise;
            } catch (r) {
...
((e, t) => {
  for (var n in t) _2(e, n, { get: t[n], enumerable: !0 });
})(
  {},
  {
    err: () => b0,
...
var go,
  ...
  B = (e, t, ...n) => {
    ...
    if (typeof e == "function") return e(t === null ? {} : t, s, T2);
    let c = Jo(e, null);
...
var S0 = !1,
  ...
  I2 = (e, t, n = !1) => {
    let r = e.$hostElement$,
      ...
      s = (a = t) && a.$tag$ === M2 ? t : B(null, null, t);
    var a;
  ...
  Ic = (e, t) => (
    ...
    4 & e.$flags$
      ? void (e.$flags$ |= 512)
      : (k0(e, e.$ancestorComponent$), S2(() => N2(e, t)))
  ),
  N2 = (e, t) => {
    let n = e.$hostElement$,
      r = (e.$cmpMeta$.$tagName$, () => {}),
  ...
  $2 = (e, t, n) =>
    we(void 0, null, function* () {
      ...
      j2(e, t, i, n), s && (s.map((c) => c()), (i["s-rc"] = void 0)), a(), o();
      {
  ...
  j2 = (e, t, n, r) => {
    try {
      (t = t.render()), (e.$flags$ &= -17), (e.$flags$ |= 2), I2(e, t, r);
    } catch (i) {
      jn(i, e.$hostElement$);
    }
    return null;
  ...
  A0 = (e) => {
    var t;
    return e.classList.add((t = v2) != null ? t : "hydrated");
  },
  U2 = (e, t, n, r) => {
    let i = Sn(e);
    if (!i)
      ...
      if (!(32 & t.$flags$)) {
        if (((t.$flags$ |= 32), n.$lazyBundleId$)) {
          let a = ((l, u, d) => {
            ...
            return hp(`./${f}.entry.js`).then((m) => (ca.set(f, m), m[h]), jn);
          })(n);
          if (a && "then" in a) {
            let l = () => {};
            (i = yield a), l();
...
var z2 = Object.freeze({
  ...
  q2 = { fontFamily: "Roboto, sans-serif" },
  Bc = ({ className: e }, t) => B("div", { style: q2, class: e }, t),
  la = ({ Icon: e, text: t }) =>
    B(
      "div",
...
function T0(e, t = "raw", n = {}) {
  ...
  let c = (function (u, d, h, f) {
    if (f === void 0) {
      ...
      for (let m = 0; m < tc.length; m++) g.add(eg(Fd(u, d, h, m, !0)), m);
      f = g.get();
    }
...
var R0 = class {
  ...
  render() {
    ...
    let e = (r) => this.i18nInstance.t(r),
      t = this.isDefaultTab ? (this.preferDesktop ? 1 : 2) : this.tab,
      n = T0(this.link, "svg", { ecc: "medium", scale: 2 });
    return B(
      Bc,
      ...
      B(
        ...
        B(
            ...
            B(
              ...
              B(
                "div",
                {
                  ...
                  class: "tab flexItem " + (t === 1 ? "tabactive" : ""),
                },
                e("DESKTOP")
              ),
              B(
                "div",
                {
                  ...
                  class: "tab flexItem " + (t === 2 ? "tabactive" : ""),
                },
                e("MOBILE")
              )
            )
          ...
          B(
            "div",
            { style: { display: t === 2 ? "none" : "block" } },
            B(
              "div",
              { class: "item" },
              B(la, { Icon: W2, text: e("INSTALL_MODAL.TRUSTED_BY_USERS") })
            ),
            B(
              "div",
              { class: "item" },
...
var O0 = class {
  ...
  render() {
    var e;
    if (!this.translationsLoaded) return null;
    let t = (e = this.displayOTP) === null || e === void 0 || e,
      n = this.sdkVersion,
